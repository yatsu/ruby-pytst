/* 
 # $Id: tst.h 1831 2006-07-17 10:22:31Z nlehuen $
...
#ifdef SCANNER
    size_t mb_len(const char*,const char*);
        ...
        if(ni_current==UNDEFINED_INDEX) {
            ...
            if(ni_best_match!=UNDEFINED_INDEX) {
                ...
                if(si_current<string.size()) {
                    ...
                    //printf("\n%d: '%s'\n", mb_len(string.substr(si_current,string.size()).data(),string.substr(string.size(),string.size()).data()),string.substr(si_current,string.size()).data());
                    si_current += mb_len(string.substr(si_current,string.size()).data(),string.substr(string.size(),string.size()).data());
                    //++si_current;
...
// This function was written based on Mecab's code.
// http://mecab.sourceforge.jp/
template<typename charT,typename valueT,typename storageT,typename serializerT, typename stringT>
 size_t tst<charT,valueT,storageT,serializerT,stringT>::mb_len(const char* begin, const char* end) {
